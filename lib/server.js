...
// heroku open --app tranquil-spire-50834
// 
// heroku restart --app tranquil-spire-50834


var util = require('util')
var http = require('http')
var path = require('path')
var ecstatic = require('ecstatic')  //For some reason if you run it in this workspace then it doesn't work. But in Sparkplug it works?
